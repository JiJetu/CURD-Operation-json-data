...
const uri = "mongodb+srv://CURD:JjFL1FpejphHfiLN@cluster0.dscp8or.mongodb.net/?retryWrites=true&w=majority";
...
async function run() {
  try {
    ...
    app.put('/users/:id', async(req, res) => {
        ...
        const result = await userDB.updateOne(filter, updateUser, options)
        res.send(result);
    })
